...
import static org.apache.giraph.conf.GiraphConstants.TERAHEAP_ENABLE;
...
public abstract class AbstractEdgeStore<I extends WritableComparable,
  ...
  protected abstract OutEdges<I, E> getVertexOutEdges(
    ...
    Map<K, OutEdges<I, E>> partitionEdgesIn, int partitionId);

  @Override
  public void addPartitionEdges(
    int partitionId, VertexIdEdges<I, E> edges) {
	// Get the edges of the current partition
	Map<K, OutEdges<I, E>> partitionEdges = getPartitionEdges(partitionId);

	// Get an iterator over the edges of the partition
    VertexIdEdgeIterator<I, E> vertexIdEdgeIterator =
    ...
    while (vertexIdEdgeIterator.hasNext()) {
	  ...
	  // Get the outedges structure of the current vertices
      OutEdges<I, E> outEdges = getVertexOutEdges(vertexIdEdgeIterator,
          partitionEdges, partitionId);

	  // Put this edge to the outEdges 
          ...
          public Void call() throws Exception {
            ...
            while (true) {
              ...
              while (iterator.hasNext()) {
				...
				//  if (TERAHEAP_ENABLE.get(configuration))
				//	  _UNSAFE.tcMarkObjectWithId(outEdges, partition.getId(), 0);
                }
                iterator.remove();
              }
